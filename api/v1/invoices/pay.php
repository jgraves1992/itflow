...
$currency_code = escapeSql($invoice['invoice_currency_code']);
...
logAudit("Invoice", "Payment", "Invoice $invoice_id marked paid via API ($api_key_name) — $payment_method $currency_code $payment_amount", $resolved_client_id, $invoice_id);
logAudit("API", "Success", "Marked invoice $invoice_id paid via API ($api_key_name)", $resolved_client_id);
