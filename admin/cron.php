...
$sql = mysqli_query($mysqli, "SELECT cron_job_id, cron_job_name, cron_job_enabled, cron_job_schedule, cron_job_interval_minutes, cron_job_daily_at, cron_job_run_now, cron_job_last_run_at, cron_job_last_duration, cron_job_last_status, cron_job_last_error, cron_job_last_error_at FROM cron_jobs");
